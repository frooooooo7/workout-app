...
const kHelpEntries = [
  ...
  HelpEntry(
    ...
    answer:
        'Edycja i usuwanie zakończonych treningów nie są jeszcze dostępne. '
        'Jeśli nie chcesz, aby trening był widoczny dla innych, otwórz go '
        'w historii i schowaj z profilu.',
  ),
  HelpEntry(
